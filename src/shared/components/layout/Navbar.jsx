...
export default function Navbar() {
  ...
  /* cerrar dropdown de notificaciones/perfil al click fuera */
  useEffect(() => {
    const onClick = (e) => {
  ...
  return (
    <>
      <style>{`
        ...
        /* ── NUEVO DISEÑO DEL PERFIL DE USUARIO ── */
        .spk-nav-user {
          position: relative;
        }
        .spk-user-toggle {
        ...
        .spk-user-avatar {
          ...
          background: linear-gradient(135deg, #b8ddf0, #ffffff);
          display: flex; align-items: center; justify-content: center;
          font-size: 12px; font-weight: 700;
          color: #004f7c; flex-shrink: 0;
        ...
        .spk-user-name {
          ...
          /* Reglas para truncar el texto */
          white-space: nowrap;
          overflow: hidden;
          text-overflow: ellipsis;
          max-width: 100px; /* Ajusta este valor si quieres que sea más largo o más corto */
          display: block;
        }
        .spk-user-role {
          font-size: 10px; color: rgba(255,255,255,.38);
          font-family: var(--mono, monospace); letter-spacing: .04em;
          white-space: nowrap;
          overflow: hidden;
          text-overflow: ellipsis;
          max-width: 100px;
        ...
        .spk-user-chevron {
          ...
          stroke: rgba(255,255,255,.45); fill: none; stroke-width: 2;
        ...
        .spk-dd-avatar {
          ...
          background: linear-gradient(135deg, #e8f4fb, #b8ddf0);
          display: flex; align-items: center; justify-content: center;
          font-size: 14px; font-weight: 700; color: #004f7c;
          border: 2px solid #b8ddf0; flex-shrink: 0;
        }
        .spk-dd-name { 
          ...
          overflow: hidden;
          text-overflow: ellipsis;
          max-width: 140px; /* Aquí le damos un poco más de espacio */
          display: block;
        }
        .spk-dd-email { 
        ...
        .spk-dd-badge {
          ...
          background: #e8f4fb; color: #0077b7;
        }
        ...
        .spk-bell-dot {
          ...
          background: var(--rojo-soft, #ef4444);
          border: 1.5px solid var(--azul, #0077b7);
          pointer-events: none;
        }
        ...
        .spk-notif-ico {
          ...
          flex-shrink: 0; margin-top: 4px; background: #0077b7;
        }
        ...
        .spk-btn-register {
          ...
          color: #0077b7; background: #ffffff;
      ...
      <nav className={`spk-nav${scrolled ? ' scrolled' : ''}`}>
        ...
        <div className="spk-nav-right">
          ...
          {/* PERFIL DE USUARIO ACTUALIZADO A OPCIÓN A */}
          {user ? (
                  ...
                  <div className="spk-dd-header">
                    ...
                    <div>
                      ...
                      <div className="spk-dd-status">
                        <span className="spk-dd-status-dot"></span>Perfil activo
                      </div>
                    </div>
                  </div>
