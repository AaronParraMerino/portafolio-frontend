      ...
      <div style={{ background: "#ffffff", padding: isMobile ? "24px 14px 40px" : "36px 24px 48px" }}>
        <div style={{ maxWidth: 680, margin: "0 auto", display: "flex", flexDirection: "column", gap: 20 }}>
          <div style={sectionLabelStyle}>
            <span style={labelTextStyle}>Gestion de cuenta</span>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            >
              <div style={cardLeftStyle}>
                ...
                <div>
                  <h3 style={cardTitleStyle}>Cerrar sesion en dispositivos</h3>
          ...
          >
            <div style={cardLeftStyle}>
              ...
              <div>
                ...
                <p style={cardTextStyle}>Esta accion es permanente e irreversible.</p>
              </div>
            </div>
