/* ══════════════════════════════════════════════
   ConfirmModal — Panel de confirmación genérico
   Reutiliza 100% los estilos de profile.css:
   prf-modal-overlay, prf-modal, prf-modal-head,
   prf-modal-body, prf-modal-foot, prf-btn-cancel,
   prf-btn-save, prf-spinner, prf-modal-close.

   Props:
   ─ title      string   Título del modal
   ─ message    string   Cuerpo descriptivo
   ─ confirmLabel string Texto del botón confirmar (default "Confirmar")
   ─ variant    'blue' | 'red'  Color del botón confirmar (default 'blue')
   ─ icon       'check' | 'warning'  Ícono del encabezado (default 'check')
   ─ loading    bool     Muestra spinner en el botón
