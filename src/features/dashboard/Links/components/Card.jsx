...
const PLATS = [
  ...
  { key:"instagram",     match:u=>u.includes("instagram.com"),                               name:"Instagram",
    icon:<svg viewBox="0 0 40 40" width={40} height={40}>
      ...
      <rect width="40" height="40" rx="8" fill="url(#ig-bg)"/>
  ...
  // ── TikTok: icono oficial con efecto 3D cyan + rojo ──────────────────
  { key:"tiktok",        match:u=>u.includes("tiktok.com"),                                   name:"TikTok",
    icon:<svg viewBox="0 0 40 40" width={40} height={40}>
      <rect width="40" height="40" rx="8" fill="#010101"/>
      {/* Sombra cyan — desplazada a la izquierda */}
      <path
        d="M23.2 10h-3.4v15.2a4 4 0 11-4-4v-3.4a7.4 7.4 0 107.4 7.4V16.8a10.8 10.8 0 006.3 2v-3.4a7.4 7.4 0 01-6.3-5.4z"
        fill="#69C9D0"
        transform="translate(-1.4,0)"
      />
      {/* Sombra roja — desplazada a la derecha */}
      <path
        d="M23.2 10h-3.4v15.2a4 4 0 11-4-4v-3.4a7.4 7.4 0 107.4 7.4V16.8a10.8 10.8 0 006.3 2v-3.4a7.4 7.4 0 01-6.3-5.4z"
        fill="#EE1D52"
        transform="translate(1.4,0)"
      />
      {/* Logo blanco principal encima */}
      <path
        d="M23.2 10h-3.4v15.2a4 4 0 11-4-4v-3.4a7.4 7.4 0 107.4 7.4V16.8a10.8 10.8 0 006.3 2v-3.4a7.4 7.4 0 01-6.3-5.4z"
        fill="white"
      />
